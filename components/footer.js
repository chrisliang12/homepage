  ...
  return (
    <div className="sticky top-[100vh] pb-1 mt-16">
      <p className="text-center opacity-20 font-light tracking-wider">
        ...
        <Link href="https://nextjs.org/" className="hover:text-sky-300">
          <TbBrandNextjs className="inline-block" />{" "}
        </Link>
        <Link href="https://tailwindcss.com/" className="hover:text-sky-300">
          <SiTailwindcss className="inline-block" />{" "}
        </Link>
        <Link
          href="https://www.framer.com/motion/"
          className="hover:text-sky-300"
        >
          <TbBrandFramer className="inline-block" />
        </Link>
      </p>
    </div>
  );
